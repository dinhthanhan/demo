...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppHeaderHeaderComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"row-sm-12\">\n    <div class=\"toolbar\">\n        <span>Tập đoàn cực to</span>\n    </div>\n</div>\n<div class=\"left\">\n</div>";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./service/service */
    "./src/app/service/service.ts"); // import { from } from 'rxjs';


    var AppComponent =
    /*#__PURE__*/
    function () {
      function AppComponent(modalService, http, serv) {
        _classCallCheck(this, AppComponent);

        this.modalService = modalService;
        this.http = http;
        this.serv = serv;
        this.title = 'demo'; // data = dataAn;
      ...
      _createClass(AppComponent, [{
        ...
        value: function chucnang() {
          ...
          this.serv.getdata("a").subscribe(function (dataAn) {
            dataAn.forEach(function (element) {
              element.Id = parseInt(element.Id);
            });
            _this.dataAn2 = dataAn;

            _this.Tree(_this.dataAn2, "Id", "IdParent");

            console.log(_this.dataAn2);
          });
        } // modal
        ...
        value: function add() {
          ...
          modalref.result.then(function (result) {
            _this2.serv.adddata(result).subscribe(function (dataAn2) {
              console.log(dataAn2);

              _this2.chucnang(); // alert("Lưu thành công");
        ...
        key: "getdata",
        value: function getdata(id, state) {
          var index = this.dataAn2.findIndex(function (x) {
            return x.Id === id;
          });
          this.selectedItem = this.dataAn2[index];
          this.selectedItem.i = index;
          this.dataAn2.forEach(function (element) {
            element.state = false;
          });
        ...
        key: "Tree",
        value: function Tree(list, Id, pId) {
          var finalData = [];
        ...
        value: function removeData() {
          ...
          if (this.selectedItem.i != undefined) {
            this.serv.removedata(this.selectedItem.Id).subscribe(function (data) {
              alert('Đã xóa!');
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_6__["HeaderComponent"], _modal_modal_component__WEBPACK_IMPORTED_MODULE_8__["ModalComponent"]],
      imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"]],
      providers: [],
